           ...
           <AnimatePresence>
             {showInfo && (
               <motion.div
                 ...
                 className="absolute bottom-full right-0 mb-2 w-56 p-3 bg-slate-900 border border-slate-700 rounded-xl shadow-xl z-50 text-left"
               >
                 ...
                 <div className="absolute -bottom-1.5 right-1.5 w-3 h-3 bg-slate-900 border-b border-r border-slate-700 rotate-45"></div>
               </motion.div>
             )}
           </AnimatePresence>
         </div>

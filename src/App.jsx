  ...
  useEffect(() => {
    ...
    const fetchTrendData = async () => {
      ...
      if (snap.exists()) {
        ...
        // Automatic Year Roll-over Cleanup: Keep only current year
...
const data = {
  ...
  projects: [
    ...
    /*{
      ...
      link: "https://cupidxus.vercel.app",
      icon: Heart,
      date: "Feb 14, 2026", 
      color: "text-rose-400", 
      bg: "bg-rose-400/10",
            ...
            {isEduModalOpen && (
              ...
              >
                <motion.div 
                  ...
                  className="bg-slate-900 border border-slate-800 rounded-2xl p-6 w-full max-sm relative shadow-2xl"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <ScaleRevealCard delay={0.1}>
                    <Card className="flex flex-col items-center justify-center p-6 h-full text-center hover:bg-slate-900/80 transition-all border border-purple-500/20 bg-purple-500/5">
                      ...
                      <span className="text-sm font-medium text-slate-300 uppercase tracking-wider mb-2">Postgraduate Studies</span>
                  ...
                  <ScaleRevealCard delay={0.2}>
                    <Card className="flex flex-col items-center justify-center p-6 h-full text-center hover:bg-slate-900/80 transition-all border border-blue-500/20 bg-blue-500/5">
                      ...
                      <span className="text-sm font-medium text-slate-300 uppercase tracking-wider mb-2">Undergraduate Studies</span>
